...
const traditionalRestaurants = [
  ...
  },
  {
    ...
    image: "/images/sabores/laboca/imagen1.jpg"
  },
  {
    ...
    image: "/images/sabores/parroquia/imagen1.jpg"
  },
  {
    ...
    image: "/images/sabores/chapala/imagen1.jpg"
  },
  {
    name: "Plaza Pardo",
    ...
    image: "/images/sabores/plazapardo/imagen1.jpg"
  },
  {
    ...
    image: "/images/sabores/humo/imagen1.jpg"
  },
  {
    ...
    image: "/images/sabores/totonaco/imagen1.jpg"
  },
  {
    ...
    image: "/images/sabores/donpope/imagen1.jpg"
  },
  {
    ...
    image: "/images/sabores/kachikin/imagen1.jpg"
  },
  {
    ...
    image: "/images/sabores/vainilla/imagen1.jpg"
  },
];

const foodBusinesses = [
  { name: "Café Catedral", address: "Curato s/n, Barrio del Naranjo, 93400 Poza Rica de Hidalgo, Ver.", phone: "784 842 5317", mapUrl: "https://maps.app.goo.gl/Xk78Zq2sGodrBbMz8", categories: ["Cafetería"], image: "/images/sabores/cafecatedral/imagen1.jpg" },
  { name: "La choza de Lucy", address: "Cjon 16 de Septiembre centro 829, Barrio del Zapote, 93400 Papantla de Olarte, Ver.", phone: "784 842 4980", mapUrl: "https://maps.app.goo.gl/ZH4ME7xq2ynUotJc8", categories: ["Mariscos"], image: "/images/sabores/chozalucy/imagen1.jpg" },
  { name: "Zacahuil \"Perla\"", address: "Cjon 16 de Septiembre 907, Barrio del Zapote, 93400 Papantla de Olarte, Ver.", phone: "784 134 6603", mapUrl: "https://maps.app.goo.gl/sZgU1sqJPnqZMnqW9", categories: ["Comida Típica"], image: "/images/sabores/zacahuilperla/imagen1.jpg" },
  { name: "SUSHI & DRINKS MR. ROLLO", address: "C. José de J. Núñez 18, Barrio del Naranjo, 93400 Papantla de Olarte, Ver.", phone: "", mapUrl: "https://maps.app.goo.gl/dhzD1EHxZC44JK9b8", categories: ["Sushi y Comida Asiática", "Bebidas y coctelería", "Snacks"], image: "/images/sabores/mrrollo/imagen1.jpeg" },
  { name: "Pizzas y Volovanes El Uli Sucursal Centro", address: "C. José de J. Núñez s/n, Centro, 93400 Papantla, Ver.", phone: "7848420064", mapUrl: "https://maps.app.goo.gl/p8kS9FGC1SPZArc87", categories: ["Pizzería", "Hamburguesas y Tortas"], image: "/images/sabores/pizzasuli/imagen1.jpeg" },
  { name: "The Italian Coffee Company", address: "s/n, Curato, Centro, Barrio del Naranjo, 93400 Papantla de Olarte", phone: "7841251585", mapUrl: "https://maps.app.goo.gl/PEMTWUC3NQLPbpes8", categories: ["Cafetería"], image: "/images/sabores/theitaliancoffeecompany/imagen1.jpeg" },
  { name: "Panificadora Lemus", address: "Cjon 16 de Septiembre 209, Santa Cruz, 93400 Papantla, Ver.", phone: "7848422558", mapUrl: "https://maps.app.goo.gl/mnvLnDMQaXBEQRA48", categories: ["Panadería"], image: "/images/sabores/panificadoralemus/imagen1.png" },
  { name: "Pizzas y Volovanes El Uli Sucursal \"16 de Septiembre\"", address: "Cjon 16 de Septiembre 800, Barrio del Zapote, 93400 Papantla de Olarte, Ver.", phone: "7848425458", mapUrl: "https://maps.app.goo.gl/VxYjy98yMQVmW5w58", categories: ["Pizzería", "Hamburguesas y Tortas"], image: "/images/sabores/pizzasuli16deseptiembre/imagen1.jpeg" },
  { name: "Idea Pizza", address: "Cjon 16 de Septiembre 101, Centro, 93400 Papantla de Olarte, Ver.", phone: "7848422083", mapUrl: "https://maps.app.goo.gl/Xk78Zq2sGodrBbMz8", categories: ["Pizzería"], image: "/images/sabores/ideapizza/imagen1.jpg" },
  { name: "Las Canastas", address: "José Azueta 105, Barrio del San Juan, 93400 Papantla de Olarte, Ver.", phone: "784 144 2168", mapUrl: "https://maps.app.goo.gl/t9JHDca26PVxULpH8", categories: ["Comida Típica"], image: "/images/sabores/lascanastas/imagen1.jpg" },
  { name: "Café Del Centro", address: "Artes 108, Barrio del San Juan, 93400 Papantla, Ver.", phone: "784 842 1163", mapUrl: "https://maps.app.goo.gl/mcuXHDvVN4Vymr4Z8", categories: ["Cafetería", "Snacks", "Hamburguesas y Tortas"], image: "/images/sabores/cafedelcentro/imagen1.jpg" },
  { name: "Me Perdonas ️", address: "C. Rodolfo Curti 118, Santa Cruz, 93400 Papantla de Olarte, Ver.", phone: "784 121 8557", mapUrl: "https://maps.app.goo.gl/BURRJANMVhE74zd6A", categories: ["Cafetería", "Snacks", "Helados y Postres"], image: "/images/sabores/meperdonas/imagen1.jpg" },
  { name: "Clandestino", address: "C. Andrés Q.R. 201, Barrio del Naranjo, 93400 Papantla de Olarte, Ver.", phone: "784 849 9423", mapUrl: "https://maps.app.goo.gl/BF1V2jTwzacvyUx39", categories: ["Hamburguesas y Tortas", "Snacks"], image: "/images/sabores/clandestino/imagen1.jpg" },
  { name: "La Jarochita", address: "Leandro Valle s/n, Centro, 93449 Papantla de Olarte, Ver.", phone: "784 134 4357", mapUrl: "https://maps.app.goo.gl/wvJmUfWwtEweX3tr7", categories: ["Mariscos", "Bebidas y coctelería", "Bares y Cantinas"], image: "/images/sabores/lajarochita/imagen1.jpg" },
  { name: "Tacos Rojos", address: "Barrio del San Juan, 93449 Papantla de Olarte, Ver.", phone: "", mapUrl: "https://maps.app.goo.gl/UzQLrQURAViDvh1A7", categories: ["Taquería"], image: "/images/sabores/tacosrojos/imagen1.jpg" },
  { name: "Super Taquería \"El Gordo\"", address: "93400 calle Francisco I. Madero FRENTE A WALDOS, A UN LADO DE SUBODEGA FRENTE A WALDOS EL, Barrio del San Juan, 93400 Papantla, Ver.", phone: "784 108 7880", mapUrl: "https://maps.app.goo.gl/2jPkouqjDNF1C6mq6", categories: ["Taquería"], image: "/images/sabores/supertaqueriaelgordo/imagen1.jpg" },
  { name: "Antojitos Doña Carmen", address: "De La Libertad 308, Barrio del Zapote, 93440 Papantla de Olarte, Ver.", phone: "784 688 1200", mapUrl: "https://maps.app.goo.gl/TdZfzCBfTW5W344M7", categories: ["Antojitos"], image: "/images/sabores/antojitosdonacarmen/imagen1.jpeg" },
  { name: "Las tortugas", address: "Centro Frente al Mural de Papantla, C. José de J. Núñez Col, Barrio del Naranjo, 93400 Papantla de Olarte, Ver.", phone: "784 121 4753", mapUrl: "https://maps.app.goo.gl/z3rgAuksDregf8Z28", categories: ["Hamburguesas y Tortas"], image: "/images/sabores/lastortugas/imagen1.jpg" },
];;
